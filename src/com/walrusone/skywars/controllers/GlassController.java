        ...
        if (glassFile.exists()) {
            ...
            if (storage.contains("colors")) {
                for (String item : storage.getStringList("colors")) {
                    ...
                    switch (color) {
                        case "white":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 0);
                            name = new Messaging.MessageFormatter().format("colors.white");
                            break;
                        case "orange":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 1);
                            name = new Messaging.MessageFormatter().format("colors.orange");
                            break;
                        case "magenta":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 2);
                            name = new Messaging.MessageFormatter().format("colors.magenta");
                            break;
                        case "lightblue":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 3);
                            name = new Messaging.MessageFormatter().format("colors.lightblue");
                            break;
                        case "yellow":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 4);
                        ...
                        case "lime":
                            ...
                            break;
                        case "pink":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 6);
                            name = new Messaging.MessageFormatter().format("colors.pink");
                            break;
                        case "gray":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 7);
                            name = new Messaging.MessageFormatter().format("colors.gray");
                            break;
                        case "lightgray":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 8);
                            name = new Messaging.MessageFormatter().format("colors.lightgray");
                            break;
                        case "cyan":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 9);
                            name = new Messaging.MessageFormatter().format("colors.cyan");
                            break;
                        case "purple":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 10);
                            name = new Messaging.MessageFormatter().format("colors.purple");
                            break;
                        case "blue":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 11);
                            name = new Messaging.MessageFormatter().format("colors.blue");
                            break;
                        case "brown":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 12);
                            name = new Messaging.MessageFormatter().format("colors.brown");
                            break;
                        case "green":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 13);
                        ...
                        case "red":
                            ...
                            break;
                        case "black":
                            itemStack = new ItemStack(Material.STAINED_GLASS, 1, (short) 15);
