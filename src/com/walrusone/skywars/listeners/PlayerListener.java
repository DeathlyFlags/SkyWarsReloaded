...
import com.walrusone.skywars.menus.*;
...
public class PlayerListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent e) {
        ...
        if (SkyWarsReloaded.getCfg().bungeeEnabled()) {
            ...
            if (inLobbyWorld(player)) {
                SkyWarsReloaded.getNMS().sendTitle(player, SkyWarsReloaded.getMessaging().getMessage("titles.joinServerTitle"), SkyWarsReloaded.getMessaging().getMessage("titles.joinServerSubtitle"));
            ...
            SkyWarsReloaded.get().getServer().getScheduler().scheduleSyncDelayedTask(SkyWarsReloaded.get(), () -> {
                if (gPlayer.getP() != null) {
                    if (gPlayer.getSpecGame() != null) {
                        ...
                        gPlayer.getP().setGameMode(GameMode.SPECTATOR);
    ...
    public void onPlayerMoveEvent(PlayerMoveEvent event) {
        ...
        if (gPlayer.inGame()) {
            ...
            switch (effect) {
                case "flame":
                    SkyWarsReloaded.getNMS().sendParticles(world, "FLAME", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((8 - 4) + 4) + 1);
                    break;
                case "smoke":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SMOKE_LARGE", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((16 - 8) + 8) + 1);
                    break;
                case "portal":
                    SkyWarsReloaded.getNMS().sendParticles(world, "PORTAL", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((140 - 80) + 80) + 1);
                    break;
                case "heart":
                    SkyWarsReloaded.getNMS().sendParticles(world, "HEART", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((10 - 3) + 3) + 1);
                    break;
                case "critical":
                    SkyWarsReloaded.getNMS().sendParticles(world, "CRIT", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((8 - 5) + 5) + 1);
                    break;
                case "water":
                    SkyWarsReloaded.getNMS().sendParticles(world, "WATER_SPLASH", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((14 - 8) + 8) + 1);
                    break;
                case "redstone":
                    SkyWarsReloaded.getNMS().sendParticles(world, "REDSTONE", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((10 - 3) + 3) + 1);
                    break;
                case "sparks":
                    SkyWarsReloaded.getNMS().sendParticles(world, "FIREWORKS_SPARK", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((8 - 4) + 4) + 1);
                    break;
                case "lava_drip":
                    SkyWarsReloaded.getNMS().sendParticles(world, "DRIP_LAVA", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((8 - 4) + 4) + 1);
                    break;
                case "lava":
                    SkyWarsReloaded.getNMS().sendParticles(world, "LAVA", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((16 - 4) + 4) + 1);
                    break;
                case "alphabet":
                    SkyWarsReloaded.getNMS().sendParticles(world, "ENCHANTMENT_TABLE", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((16 - 8) + 8) + 1);
                    break;
                case "happy":
                    SkyWarsReloaded.getNMS().sendParticles(world, "VILLAGER_HAPPY", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 4) + 4) + 1);
                    break;
                case "magic":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SPELL_WITCH", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((10 - 7) + 7) + 1);
                    break;
                case "music":
                    SkyWarsReloaded.getNMS().sendParticles(world, "NOTE", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((10 - 4) + 4) + 1);
                    break;
                case "angry":
                    SkyWarsReloaded.getNMS().sendParticles(world, "VILLAGER_ANGRY", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((5 - 2) + 2) + 1);
                    break;
                case "clouds":
                    SkyWarsReloaded.getNMS().sendParticles(world, "CLOUD", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 6) + 6) + 1);
                    break;
                case "potion":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SPELL", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 6) + 6) + 1);
                    break;
                case "poison":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SPELL_INSTANT", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 6) + 6) + 1);
                    break;
                case "snow":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SNOWBALL", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 6) + 6) + 1);
                    break;
                case "slime":
                    SkyWarsReloaded.getNMS().sendParticles(world, "SLIME", (float) location.getX(), (float) location.getY(), (float) location.getZ(), random.nextFloat(), random.nextFloat(), random.nextFloat(), random.nextInt((12 - 6) + 6) + 1);
                    break;
                default:
                    break;
            }
