...
public class BuyColorMenu {
            ...
            public void onOptionClick(IconMenu.OptionClickEvent event) {
                ...
                if (canPurchase(gamePlayer, glass)) {
                    ...
                    if (hasColorPermission(gamePlayer, glass)) {
                        ...
                        if (!gamePlayer.inGame()) {
                            SkyWarsReloaded.get().getServer().getScheduler().scheduleSyncDelayedTask(SkyWarsReloaded.get(), () -> updateBuyColorMenu(gamePlayer), 2);
                        }
                    }
                }
            }
    ...
    private void updateBuyColorMenu(final GamePlayer gamePlayer) {
    ...
    private boolean canPurchase(GamePlayer gamePlayer, GlassColor gColor) {
        if (SkyWarsReloaded.getCfg().usingExternalEcomony()) {
