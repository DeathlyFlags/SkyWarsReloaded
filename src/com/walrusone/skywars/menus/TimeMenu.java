...
class TimeMenu {
    ...
    public TimeMenu(final GamePlayer gamePlayer) {
        ...
        SkyWarsReloaded.getIC().create(gamePlayer.getP(), timeMenuName, rowCount, event -> {
            ...
            if (gamePlayer.getTimeVote() != lastVote) {
                ...
                game.getPlayers().stream().filter(gPlayer -> gPlayer.getP() != null).forEach(gPlayer -> gPlayer.getP().sendMessage(new Messaging.MessageFormatter()
                        .withPrefix()
